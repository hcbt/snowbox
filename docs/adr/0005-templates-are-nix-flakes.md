...
Authoring a Template is the hatch: there is no Snowbox-specific template format. A Template is a Nix flake. The GUI can still pick and save Templates; “save” writes a flake, and anyone who needs to can edit that flake.
